...
public class RegressionTest17 {
    ...
    public void test8516() throws Throwable {
        ...
        java.lang.String str89 = produto71.getNome();
        java.lang.String str90 = produto71.getNome();
        double double91 = produto71.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + false + "'", boolean14 == false);
    ...
    public void test8518() throws Throwable {
        ...
        br.ufrn.imd.Produto produto3 = new br.ufrn.imd.Produto("hi!", "hi!", (double) 86);
    }
    ...
    public void test8522() throws Throwable {
        ...
        estoque37.inserirProduto(produto43, (int) (byte) -1);
        int int51 = estoque37.consultarQuantidade("");
        boolean boolean53 = estoque37.produtoExiste("");
        ...
        estoque37.inserirProduto(produto59, 1);
        java.lang.String str69 = produto59.getNome();
        estoque0.inserirProduto(produto59, (-28));
    ...
    public void test8527() throws Throwable {
        ...
        java.lang.String str46 = produto37.getNome();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + (-2) + "'", int19 == (-2));
        org.junit.Assert.assertEquals("'" + str28 + "' != '" + "hi!" + "'", str28, "hi!");
    ...
    public void test8532() throws Throwable {
        ...
        try {
            estoque0.removerProduto("hi!", (-112));
    ...
    public void test8553() throws Throwable {
        ...
        int int45 = estoque28.consultarQuantidade("");
    ...
    public void test8559() throws Throwable {
        ...
        produto41.setPreco((double) 100.0f);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int24 + "' != '" + (-1) + "'", int24 == (-1));
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "hi!" + "'", str33, "hi!");
        org.junit.Assert.assertTrue("'" + double34 + "' != '" + 10.0d + "'", double34 == 10.0d);
    ...
    public void test8565() throws Throwable {
        ...
        br.ufrn.imd.Produto produto3 = new br.ufrn.imd.Produto("hi!", "hi!", (double) 125);
    }
    ...
    public void test8574() throws Throwable {
        ...
        java.lang.String str47 = produto31.getCodigo();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + true + "'", boolean14 == true);
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "hi!" + "'", str23, "hi!");
        org.junit.Assert.assertEquals("'" + str40 + "' != '" + "" + "'", str40, "");
    ...
    public void test8578() throws Throwable {
        ...
        br.ufrn.imd.Produto produto83 = new br.ufrn.imd.Produto("hi!", "", (double) (-56));
        estoque0.inserirProduto(produto83, 136);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean24 + "' != '" + false + "'", boolean24 == false);
        org.junit.Assert.assertTrue("'" + boolean26 + "' != '" + true + "'", boolean26 == true);
    ...
    public void test8579() throws Throwable {
        ...
        br.ufrn.imd.Produto produto60 = new br.ufrn.imd.Produto("", "", (double) 18);
        java.lang.String str61 = produto60.getNome();
        estoque0.inserirProduto(produto60, (-20));
    ...
    public void test8589() throws Throwable {
        ...
        java.lang.Class<?> wildcardClass89 = produto72.getClass();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int24 + "' != '" + (-1) + "'", int24 == (-1));
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "hi!" + "'", str33, "hi!");
        org.junit.Assert.assertTrue("'" + double34 + "' != '" + 10.0d + "'", double34 == 10.0d);
    ...
    public void test8590() throws Throwable {
        ...
        estoque0.inserirProduto(produto55, (int) '#');
        java.lang.String str69 = produto55.getCodigo();
        org.junit.Assert.assertTrue("'" + boolean22 + "' != '" + false + "'", boolean22 == false);
        org.junit.Assert.assertTrue("'" + boolean25 + "' != '" + false + "'", boolean25 == false);
    ...
    public void test8597() throws Throwable {
        ...
        br.ufrn.imd.Produto produto3 = new br.ufrn.imd.Produto("", "", (double) 199);
    }
    ...
    public void test8598() throws Throwable {
        ...
        br.ufrn.imd.Produto produto19 = new br.ufrn.imd.Produto("hi!", "hi!", (double) 100);
        produto19.setCodigo("hi!");
        estoque15.inserirProduto(produto19, (int) (byte) 0);
        estoque15.removerProduto("hi!", (int) (byte) 100);
        int int28 = estoque15.consultarQuantidade("");
        boolean boolean30 = estoque15.produtoExiste("");
        boolean boolean32 = estoque15.produtoExiste("hi!");
        br.ufrn.imd.Produto produto36 = new br.ufrn.imd.Produto("hi!", "hi!", 10.0d);
        produto36.setNome("");
        java.lang.String str39 = produto36.getNome();
        estoque15.inserirProduto(produto36, (int) (byte) 10);
        produto36.setPreco((-3.0d));
        estoque0.inserirProduto(produto36, (int) (byte) 10);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 0 + "'", int4 == 0);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 0 + "'", int6 == 0);
    ...
    public void test8604() throws Throwable {
        ...
        produto53.setCodigo("");
        produto53.setPreco((double) 1.0f);
        java.lang.String str66 = produto53.getNome();
        java.lang.String str67 = produto53.getNome();
        produto53.setNome("");
    ...
    public void test8605() throws Throwable {
        ...
        br.ufrn.imd.Produto produto26 = new br.ufrn.imd.Produto("", "", (double) 109);
        java.lang.String str27 = produto26.getCodigo();
        produto26.setCodigo("");
        produto26.setNome("hi!");
        estoque0.inserirProduto(produto26, (-78));
        br.ufrn.imd.Estoque estoque34 = new br.ufrn.imd.Estoque();
        boolean boolean36 = estoque34.produtoExiste("");
        br.ufrn.imd.Produto produto40 = new br.ufrn.imd.Produto("", "hi!", (double) 10);
        produto40.setNome("hi!");
        ...
        java.lang.String str62 = produto57.getCodigo();
        double double63 = produto57.getPreco();
        produto57.setPreco((double) 1.0f);
        estoque34.inserirProduto(produto57, (int) (short) 0);
        int int69 = estoque34.consultarQuantidade("hi!");
        int int71 = estoque34.consultarQuantidade("");
        boolean boolean73 = estoque34.produtoExiste("");
        ...
        estoque34.inserirProduto(produto77, (int) (byte) 1);
        produto77.setNome("");
        produto77.setPreco(100.0d);
        double double89 = produto77.getPreco();
    ...
    public void test8606() throws Throwable {
        ...
        produto25.setCodigo("");
        java.lang.String str45 = produto25.getCodigo();
        java.lang.String str46 = produto25.getNome();
    ...
    public void test8607() throws Throwable {
        ...
        java.lang.String str79 = produto59.getCodigo();
        produto59.setPreco(52.0d);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + 0 + "'", int17 == 0);
        org.junit.Assert.assertTrue("'" + boolean25 + "' != '" + false + "'", boolean25 == false);
        org.junit.Assert.assertTrue("'" + boolean27 + "' != '" + true + "'", boolean27 == true);
    ...
    public void test8611() throws Throwable {
        ...
        produto55.setNome("");
        java.lang.Class<?> wildcardClass64 = produto55.getClass();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + false + "'", boolean18 == false);
    ...
    public void test8619() throws Throwable {
        ...
        java.lang.String str45 = produto33.getNome();
        java.lang.Class<?> wildcardClass46 = produto33.getClass();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + false + "'", boolean18 == false);
    ...
    public void test8623() throws Throwable {
        ...
        double double52 = produto39.getPreco();
        produto39.setNome("hi!");
        estoque0.inserirProduto(produto39, (-132));
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
    ...
    public void test8624() throws Throwable {
        ...
        int int56 = estoque37.consultarQuantidade("hi!");
        ...
        estoque37.inserirProduto(produto60, 0);
        br.ufrn.imd.Produto produto76 = new br.ufrn.imd.Produto("", "", (double) 0L);
        java.lang.String str77 = produto76.getNome();
        estoque37.inserirProduto(produto76, (int) (short) 0);
        java.lang.String str80 = produto76.getCodigo();
        produto76.setCodigo("hi!");
        produto76.setPreco((double) 119);
        produto76.setNome("");
        double double87 = produto76.getPreco();
        estoque0.inserirProduto(produto76, 132);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + true + "'", boolean16 == true);
        org.junit.Assert.assertTrue("'" + boolean39 + "' != '" + false + "'", boolean39 == false);
        ...
        org.junit.Assert.assertTrue("'" + double87 + "' != '" + 119.0d + "'", double87 == 119.0d);
    }
    ...
    public void test8627() throws Throwable {
        ...
        double double77 = produto55.getPreco();
        org.junit.Assert.assertTrue("'" + boolean26 + "' != '" + false + "'", boolean26 == false);
        org.junit.Assert.assertTrue("'" + boolean29 + "' != '" + false + "'", boolean29 == false);
        org.junit.Assert.assertTrue("'" + int51 + "' != '" + (-1) + "'", int51 == (-1));
        org.junit.Assert.assertEquals("'" + str60 + "' != '" + "hi!" + "'", str60, "hi!");
    ...
    public void test8630() throws Throwable {
        ...
        br.ufrn.imd.Produto produto74 = new br.ufrn.imd.Produto("", "hi!", (double) 1L);
        produto74.setNome("");
        estoque56.inserirProduto(produto74, (int) (byte) 10);
        boolean boolean80 = estoque56.produtoExiste("");
        int int82 = estoque56.consultarQuantidade("");
        estoque56.removerProduto("hi!", 10);
        estoque56.removerProduto("hi!", (int) (short) 10);
        br.ufrn.imd.Produto produto92 = new br.ufrn.imd.Produto("hi!", "hi!", (double) ' ');
        estoque56.inserirProduto(produto92, 97);
        produto92.setPreco(0.0d);
        double double97 = produto92.getPreco();
        estoque0.inserirProduto(produto92, 92);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + double32 + "' != '" + 100.0d + "'", double32 == 100.0d);
        org.junit.Assert.assertEquals("'" + str35 + "' != '" + "hi!" + "'", str35, "hi!");
    ...
    public void test8632() throws Throwable {
        ...
        br.ufrn.imd.Produto produto3 = new br.ufrn.imd.Produto("hi!", "", (double) 26);
    }
    ...
    public void test8636() throws Throwable {
        ...
        double double88 = produto68.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + 0 + "'", int17 == 0);
        org.junit.Assert.assertTrue("'" + boolean25 + "' != '" + false + "'", boolean25 == false);
        org.junit.Assert.assertTrue("'" + boolean28 + "' != '" + false + "'", boolean28 == false);
    ...
    public void test8644() throws Throwable {
        ...
        produto56.setPreco((double) (short) 100);
        produto56.setCodigo("");
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int24 + "' != '" + (-1) + "'", int24 == (-1));
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "hi!" + "'", str33, "hi!");
    ...
    public void test8654() throws Throwable {
        ...
        boolean boolean57 = estoque43.produtoExiste("");
        int int59 = estoque43.consultarQuantidade("");
        br.ufrn.imd.Produto produto63 = new br.ufrn.imd.Produto("", "hi!", (double) 10);
        produto63.setNome("hi!");
        java.lang.String str66 = produto63.getCodigo();
        estoque43.inserirProduto(produto63, (-1));
        boolean boolean70 = estoque43.produtoExiste("");
        boolean boolean72 = estoque43.produtoExiste("");
        br.ufrn.imd.Produto produto76 = new br.ufrn.imd.Produto("", "hi!", (double) 10);
        java.lang.String str77 = produto76.getCodigo();
        produto76.setCodigo("hi!");
        produto76.setNome("hi!");
        estoque43.inserirProduto(produto76, 18);
        produto76.setCodigo("hi!");
        produto76.setNome("hi!");
        produto76.setPreco((double) (-36));
        estoque0.inserirProduto(produto76, 179);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + double26 + "' != '" + 100.0d + "'", double26 == 100.0d);
    ...
    public void test8656() throws Throwable {
        ...
        br.ufrn.imd.Produto produto3 = new br.ufrn.imd.Produto("hi!", "hi!", (double) 77);
    }
    ...
    public void test8657() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int58 + "' != '" + 199 + "'", int58 == 199);
    }
    ...
    public void test8658() throws Throwable {
        ...
        produto52.setNome("hi!");
        estoque0.inserirProduto(produto52, 100);
        java.lang.Class<?> wildcardClass68 = produto52.getClass();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + (-2) + "'", int19 == (-2));
        org.junit.Assert.assertEquals("'" + str28 + "' != '" + "hi!" + "'", str28, "hi!");
    ...
    public void test8662() throws Throwable {
        ...
        produto46.setNome("hi!");
        produto46.setNome("");
        produto46.setPreco(1.0d);
        estoque34.inserirProduto(produto46, 100);
        produto46.setCodigo("");
        produto46.setPreco((double) (-63));
        estoque0.inserirProduto(produto46, (int) ' ');
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + false + "'", boolean14 == false);
        org.junit.Assert.assertTrue("'" + boolean28 + "' != '" + false + "'", boolean28 == false);
        org.junit.Assert.assertTrue("'" + boolean33 + "' != '" + true + "'", boolean33 == true);
    ...
    public void test8664() throws Throwable {
        ...
        br.ufrn.imd.Produto produto53 = new br.ufrn.imd.Produto("", "hi!", 32.0d);
        java.lang.String str54 = produto53.getNome();
        estoque0.inserirProduto(produto53, (-29));
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean24 + "' != '" + false + "'", boolean24 == false);
        org.junit.Assert.assertTrue("'" + int44 + "' != '" + (-1) + "'", int44 == (-1));
    ...
    public void test8670() throws Throwable {
        ...
        double double99 = produto96.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean30 + "' != '" + false + "'", boolean30 == false);
        ...
        org.junit.Assert.assertTrue("'" + double99 + "' != '" + (-98.0d) + "'", double99 == (-98.0d));
    }
    ...
    public void test8676() throws Throwable {
        ...
        produto42.setNome("hi!");
        produto42.setPreco((double) 10);
        java.lang.String str47 = produto42.getCodigo();
        double double48 = produto42.getPreco();
        produto42.setPreco((double) 1.0f);
        produto42.setPreco((double) '4');
        produto42.setCodigo("");
        produto42.setCodigo("hi!");
        java.lang.String str57 = produto42.getNome();
        produto42.setCodigo("hi!");
        produto42.setNome("");
        double double62 = produto42.getPreco();
        estoque0.inserirProduto(produto42, (-90));
    ...
    public void test8679() throws Throwable {
        ...
        br.ufrn.imd.Produto produto52 = new br.ufrn.imd.Produto("", "hi!", (-1.0d));
        produto52.setCodigo("");
        estoque0.inserirProduto(produto52, 114);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
        org.junit.Assert.assertTrue("'" + boolean19 + "' != '" + false + "'", boolean19 == false);
    ...
    public void test8681() throws Throwable {
        ...
        int int45 = estoque41.consultarQuantidade("hi!");
        int int47 = estoque41.consultarQuantidade("");
        br.ufrn.imd.Produto produto51 = new br.ufrn.imd.Produto("hi!", "", (double) 9);
        estoque41.inserirProduto(produto51, (int) '#');
        int int55 = estoque41.consultarQuantidade("hi!");
        br.ufrn.imd.Produto produto59 = new br.ufrn.imd.Produto("", "hi!", (double) 10);
        produto59.setNome("hi!");
        produto59.setPreco((double) 10);
        java.lang.String str64 = produto59.getCodigo();
        double double65 = produto59.getPreco();
        double double66 = produto59.getPreco();
        estoque41.inserirProduto(produto59, 33);
        java.lang.String str69 = produto59.getCodigo();
        produto59.setPreco(34.0d);
        double double72 = produto59.getPreco();
        produto59.setCodigo("hi!");
        estoque0.inserirProduto(produto59, (-196));
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int24 + "' != '" + (-1) + "'", int24 == (-1));
        org.junit.Assert.assertTrue("'" + boolean29 + "' != '" + true + "'", boolean29 == true);
        org.junit.Assert.assertEquals("'" + str34 + "' != '" + "" + "'", str34, "");
    ...
    public void test8694() throws Throwable {
        ...
        boolean boolean29 = estoque0.produtoExiste("hi!");
        int int31 = estoque0.consultarQuantidade("hi!");
        br.ufrn.imd.Produto produto32 = null;
        // The following exception was thrown during execution in test generation
        try {
            estoque0.inserirProduto(produto32, 0);
    ...
    public void test8705() throws Throwable {
        ...
        produto59.setCodigo("");
        produto59.setNome("");
        estoque0.inserirProduto(produto59, (-67));
        produto59.setNome("hi!");
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
    ...
    public void test8727() throws Throwable {
        ...
        produto42.setNome("hi!");
        java.lang.String str66 = produto42.getNome();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean22 + "' != '" + false + "'", boolean22 == false);
        org.junit.Assert.assertTrue("'" + boolean25 + "' != '" + false + "'", boolean25 == false);
    ...
    public void test8732() throws Throwable {
        ...
        int int48 = estoque0.consultarQuantidade("");
        br.ufrn.imd.Produto produto52 = new br.ufrn.imd.Produto("", "hi!", (double) 100);
        double double53 = produto52.getPreco();
        produto52.setNome("hi!");
        java.lang.String str56 = produto52.getCodigo();
        produto52.setCodigo("hi!");
        java.lang.String str59 = produto52.getNome();
        produto52.setCodigo("hi!");
        produto52.setNome("");
    ...
    public void test8734() throws Throwable {
        ...
        br.ufrn.imd.Produto produto3 = new br.ufrn.imd.Produto("", "hi!", (double) (-170));
    }
    ...
    public void test8735() throws Throwable {
        ...
        double double88 = produto63.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean24 + "' != '" + false + "'", boolean24 == false);
        org.junit.Assert.assertEquals("'" + str35 + "' != '" + "hi!" + "'", str35, "hi!");
    ...
    public void test8738() throws Throwable {
        ...
        produto65.setNome("");
        java.lang.Class<?> wildcardClass89 = produto65.getClass();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean24 + "' != '" + false + "'", boolean24 == false);
        org.junit.Assert.assertEquals("'" + str35 + "' != '" + "hi!" + "'", str35, "hi!");
    ...
    public void test8742() throws Throwable {
        ...
        double double91 = produto68.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int24 + "' != '" + (-1) + "'", int24 == (-1));
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "hi!" + "'", str33, "hi!");
        org.junit.Assert.assertTrue("'" + double34 + "' != '" + 10.0d + "'", double34 == 10.0d);
    ...
    public void test8748() throws Throwable {
        ...
        br.ufrn.imd.Produto produto58 = new br.ufrn.imd.Produto("", "", (double) 0.0f);
        produto58.setPreco(97.0d);
        java.lang.String str61 = produto58.getNome();
        produto58.setPreco(0.0d);
        produto58.setPreco((-99.0d));
    ...
    public void test8750() throws Throwable {
        ...
        produto59.setPreco((double) 10);
        estoque53.inserirProduto(produto59, (int) (byte) -1);
        int int67 = estoque53.consultarQuantidade("");
        estoque53.removerProduto("hi!", 1);
        br.ufrn.imd.Produto produto74 = new br.ufrn.imd.Produto("", "hi!", (double) 100);
        produto74.setPreco((double) '#');
        produto74.setNome("");
        estoque53.inserirProduto(produto74, (int) (byte) 1);
        java.lang.String str81 = produto74.getNome();
        produto74.setCodigo("");
        produto74.setPreco(97.0d);
        estoque0.inserirProduto(produto74, 33);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int24 + "' != '" + (-1) + "'", int24 == (-1));
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "hi!" + "'", str33, "hi!");
        org.junit.Assert.assertTrue("'" + double34 + "' != '" + 10.0d + "'", double34 == 10.0d);
    ...
    public void test8752() throws Throwable {
        ...
        produto28.setNome("");
        java.lang.String str51 = produto28.getNome();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int24 + "' != '" + (-1) + "'", int24 == (-1));
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "hi!" + "'", str33, "hi!");
        org.junit.Assert.assertTrue("'" + double34 + "' != '" + 10.0d + "'", double34 == 10.0d);
    ...
    public void test8754() throws Throwable {
        ...
        boolean boolean18 = estoque0.produtoExiste("hi!");
        int int20 = estoque0.consultarQuantidade("");
        br.ufrn.imd.Produto produto24 = new br.ufrn.imd.Produto("hi!", "", 34.0d);
        estoque0.inserirProduto(produto24, 119);
        boolean boolean28 = estoque0.produtoExiste("");
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + false + "'", boolean14 == false);
        org.junit.Assert.assertTrue("'" + int16 + "' != '" + 0 + "'", int16 == 0);
    ...
    public void test8755() throws Throwable {
        ...
        double double62 = produto44.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int24 + "' != '" + (-1) + "'", int24 == (-1));
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "hi!" + "'", str33, "hi!");
        org.junit.Assert.assertTrue("'" + double34 + "' != '" + 10.0d + "'", double34 == 10.0d);
    ...
    public void test8758() throws Throwable {
        ...
        br.ufrn.imd.Produto produto3 = new br.ufrn.imd.Produto("hi!", "", (double) (-146));
    }
    ...
    public void test8766() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int90 + "' != '" + 199 + "'", int90 == 199);
    }
    ...
    public void test8767() throws Throwable {
        ...
        br.ufrn.imd.Produto produto24 = new br.ufrn.imd.Produto("", "", (double) 0.0f);
        produto24.setNome("hi!");
        estoque0.inserirProduto(produto24, (-101));
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
    }
    ...
    public void test8770() throws Throwable {
        ...
        java.lang.Class<?> wildcardClass87 = produto72.getClass();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertEquals("'" + str24 + "' != '" + "hi!" + "'", str24, "hi!");
        org.junit.Assert.assertTrue("'" + double25 + "' != '" + 10.0d + "'", double25 == 10.0d);
        org.junit.Assert.assertEquals("'" + str26 + "' != '" + "hi!" + "'", str26, "hi!");
    ...
    public void test8775() throws Throwable {
        ...
        produto52.setNome("hi!");
        estoque0.inserirProduto(produto52, 100);
        br.ufrn.imd.Produto produto71 = new br.ufrn.imd.Produto("", "hi!", 10.0d);
        estoque0.inserirProduto(produto71, 51);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + (-2) + "'", int19 == (-2));
        org.junit.Assert.assertEquals("'" + str28 + "' != '" + "hi!" + "'", str28, "hi!");
    ...
    public void test8779() throws Throwable {
        ...
        br.ufrn.imd.Produto produto3 = new br.ufrn.imd.Produto("", "", 104.0d);
    }
    ...
    public void test8780() throws Throwable {
        ...
        java.lang.String str35 = produto22.getNome();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + false + "'", boolean18 == false);
    ...
    public void test8783() throws Throwable {
        ...
        double double33 = produto12.getPreco();
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "" + "'", str23, "");
        org.junit.Assert.assertEquals("'" + str24 + "' != '" + "" + "'", str24, "");
        org.junit.Assert.assertTrue("'" + double25 + "' != '" + 0.0d + "'", double25 == 0.0d);
    ...
    public void test8796() throws Throwable {
        ...
        br.ufrn.imd.Produto produto81 = new br.ufrn.imd.Produto("", "", (double) (short) 10);
        double double82 = produto81.getPreco();
        produto81.setCodigo("");
        produto81.setNome("hi!");
        produto81.setNome("");
        java.lang.String str89 = produto81.getNome();
        estoque0.inserirProduto(produto81, (-150));
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + double26 + "' != '" + 100.0d + "'", double26 == 100.0d);
        org.junit.Assert.assertEquals("'" + str27 + "' != '" + "hi!" + "'", str27, "hi!");
        org.junit.Assert.assertEquals("'" + str28 + "' != '" + "" + "'", str28, "");
    ...
    public void test8819() throws Throwable {
        ...
        produto21.setCodigo("");
        double double43 = produto21.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertEquals("'" + str28 + "' != '" + "hi!" + "'", str28, "hi!");
        org.junit.Assert.assertTrue("'" + double29 + "' != '" + 10.0d + "'", double29 == 10.0d);
    ...
    public void test8820() throws Throwable {
        ...
        java.lang.String str29 = produto27.getNome();
        java.lang.String str30 = produto27.getNome();
        estoque0.inserirProduto(produto27, (-88));
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + 0 + "'", int13 == 0);
        org.junit.Assert.assertTrue("'" + boolean15 + "' != '" + false + "'", boolean15 == false);
        org.junit.Assert.assertTrue("'" + boolean23 + "' != '" + false + "'", boolean23 == false);
        org.junit.Assert.assertTrue("'" + double28 + "' != '" + 10.0d + "'", double28 == 10.0d);
    ...
    public void test8823() throws Throwable {
        ...
        produto52.setNome("");
        java.lang.String str68 = produto52.getCodigo();
        org.junit.Assert.assertTrue("'" + boolean23 + "' != '" + true + "'", boolean23 == true);
        org.junit.Assert.assertTrue("'" + boolean26 + "' != '" + false + "'", boolean26 == false);
        org.junit.Assert.assertEquals("'" + str53 + "' != '" + "hi!" + "'", str53, "hi!");
    ...
    public void test8824() throws Throwable {
        ...
        double double68 = produto64.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + int19 + "' != '" + (-2) + "'", int19 == (-2));
        org.junit.Assert.assertEquals("'" + str28 + "' != '" + "hi!" + "'", str28, "hi!");
    ...
    public void test8827() throws Throwable {
        ...
        java.lang.String str48 = produto46.getCodigo();
        java.lang.String str49 = produto46.getNome();
        produto46.setCodigo("");
        double double52 = produto46.getPreco();
        java.lang.String str53 = produto46.getNome();
        double double54 = produto46.getPreco();
        produto46.setCodigo("");
        java.lang.String str57 = produto46.getNome();
        estoque0.inserirProduto(produto46, (-196));
        org.junit.Assert.assertTrue("'" + boolean22 + "' != '" + true + "'", boolean22 == true);
        org.junit.Assert.assertTrue("'" + boolean24 + "' != '" + false + "'", boolean24 == false);
        org.junit.Assert.assertTrue("'" + int26 + "' != '" + 0 + "'", int26 == 0);
    ...
    public void test8830() throws Throwable {
        ...
        produto49.setCodigo("hi!");
        java.lang.String str63 = produto49.getCodigo();
        estoque0.inserirProduto(produto49, (int) (byte) -1);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + 0 + "'", int17 == 0);
        org.junit.Assert.assertTrue("'" + int25 + "' != '" + 0 + "'", int25 == 0);
    ...
    public void test8837() throws Throwable {
        ...
        java.lang.String str70 = produto53.getNome();
        estoque0.inserirProduto(produto53, (-32));
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "" + "'", str23, "");
        org.junit.Assert.assertTrue("'" + int36 + "' != '" + 97 + "'", int36 == 97);
        org.junit.Assert.assertTrue("'" + boolean39 + "' != '" + false + "'", boolean39 == false);
    ...
    public void test8839() throws Throwable {
        ...
        estoque0.removerProduto("hi!", 115);
        br.ufrn.imd.Produto produto75 = new br.ufrn.imd.Produto("hi!", "", (double) (byte) 1);
        produto75.setPreco((double) 114);
    ...
    public void test8840() throws Throwable {
        ...
        br.ufrn.imd.Produto produto3 = new br.ufrn.imd.Produto("", "hi!", 42.0d);
    }
    ...
    public void test8847() throws Throwable {
        ...
        org.junit.Assert.assertEquals("'" + str10 + "' != '" + "hi!" + "'", str10, "hi!");
        org.junit.Assert.assertEquals("'" + str15 + "' != '" + "hi!" + "'", str15, "hi!");
        org.junit.Assert.assertTrue("'" + double18 + "' != '" + (-68.0d) + "'", double18 == (-68.0d));
        org.junit.Assert.assertTrue("'" + double19 + "' != '" + (-68.0d) + "'", double19 == (-68.0d));
    }
    ...
    public void test8858() throws Throwable {
        ...
        produto58.setNome("hi!");
        double double79 = produto58.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int24 + "' != '" + (-1) + "'", int24 == (-1));
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "hi!" + "'", str33, "hi!");
        org.junit.Assert.assertTrue("'" + double34 + "' != '" + 10.0d + "'", double34 == 10.0d);
    ...
    public void test8859() throws Throwable {
        ...
        double double52 = produto33.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + true + "'", boolean16 == true);
        org.junit.Assert.assertEquals("'" + str25 + "' != '" + "" + "'", str25, "");
    ...
    public void test8881() throws Throwable {
        ...
        java.lang.Class<?> wildcardClass53 = produto32.getClass();
        org.junit.Assert.assertTrue("'" + int13 + "' != '" + 0 + "'", int13 == 0);
        org.junit.Assert.assertTrue("'" + boolean15 + "' != '" + false + "'", boolean15 == false);
        org.junit.Assert.assertEquals("'" + str37 + "' != '" + "hi!" + "'", str37, "hi!");
    ...
    public void test8886() throws Throwable {
        ...
        double double74 = produto72.getPreco();
        java.lang.String str75 = produto72.getNome();
        java.lang.String str76 = produto72.getNome();
        estoque0.inserirProduto(produto72, (-120));
    ...
    public void test8888() throws Throwable {
        ...
        java.lang.String str93 = produto81.getNome();
        java.lang.String str94 = produto81.getNome();
        java.lang.String str95 = produto81.getNome();
        estoque0.inserirProduto(produto81, (-80));
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertEquals("'" + str23 + "' != '" + "" + "'", str23, "");
        org.junit.Assert.assertTrue("'" + boolean27 + "' != '" + true + "'", boolean27 == true);
        org.junit.Assert.assertTrue("'" + int29 + "' != '" + 97 + "'", int29 == 97);
    ...
    public void test8897() throws Throwable {
        ...
        boolean boolean66 = estoque0.produtoExiste("");
        int int68 = estoque0.consultarQuantidade("");
        br.ufrn.imd.Produto produto72 = new br.ufrn.imd.Produto("", "", (double) 98);
        double double73 = produto72.getPreco();
        produto72.setNome("");
        java.lang.String str76 = produto72.getNome();
        java.lang.String str77 = produto72.getCodigo();
        estoque0.inserirProduto(produto72, (-146));
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + false + "'", boolean18 == false);
        ...
        org.junit.Assert.assertTrue("'" + double73 + "' != '" + 98.0d + "'", double73 == 98.0d);
        org.junit.Assert.assertEquals("'" + str76 + "' != '" + "" + "'", str76, "");
        org.junit.Assert.assertEquals("'" + str77 + "' != '" + "" + "'", str77, "");
    }
    ...
    public void test8902() throws Throwable {
        ...
        java.lang.String str43 = produto38.getCodigo();
        estoque0.inserirProduto(produto38, (-113));
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + boolean14 + "' != '" + true + "'", boolean14 == true);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
        org.junit.Assert.assertTrue("'" + int18 + "' != '" + 0 + "'", int18 == 0);
    ...
    public void test8904() throws Throwable {
        ...
        double double83 = produto73.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int24 + "' != '" + (-1) + "'", int24 == (-1));
        org.junit.Assert.assertTrue("'" + boolean29 + "' != '" + true + "'", boolean29 == true);
        org.junit.Assert.assertTrue("'" + int31 + "' != '" + 0 + "'", int31 == 0);
    ...
    public void test8908() throws Throwable {
        ...
        produto42.setNome("hi!");
        produto42.setNome("hi!");
        java.lang.Class<?> wildcardClass60 = produto42.getClass();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + false + "'", boolean18 == false);
    ...
    public void test8913() throws Throwable {
        ...
        produto83.setPreco((double) 36);
        estoque0.inserirProduto(produto83, (int) ' ');
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + false + "'", boolean18 == false);
    ...
    public void test8918() throws Throwable {
        ...
        produto58.setCodigo("hi!");
        produto58.setCodigo("");
        double double63 = produto58.getPreco();
        estoque0.inserirProduto(produto58, 68);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertEquals("'" + str28 + "' != '" + "hi!" + "'", str28, "hi!");
        org.junit.Assert.assertTrue("'" + double29 + "' != '" + 10.0d + "'", double29 == 10.0d);
    ...
    public void test8930() throws Throwable {
        ...
        produto46.setCodigo("");
        double double63 = produto46.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertEquals("'" + str28 + "' != '" + "hi!" + "'", str28, "hi!");
        org.junit.Assert.assertTrue("'" + double29 + "' != '" + 10.0d + "'", double29 == 10.0d);
    ...
    public void test8939() throws Throwable {
        ...
        java.lang.String str75 = produto61.getCodigo();
        produto61.setNome("hi!");
        estoque0.inserirProduto(produto61, (-9));
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean16 + "' != '" + false + "'", boolean16 == false);
        org.junit.Assert.assertTrue("'" + boolean18 + "' != '" + false + "'", boolean18 == false);
    ...
    public void test8948() throws Throwable {
        ...
        br.ufrn.imd.Produto produto3 = new br.ufrn.imd.Produto("", "", (double) 135);
    }
    ...
    public void test8956() throws Throwable {
        ...
        produto72.setPreco((double) (byte) -1);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertEquals("'" + str24 + "' != '" + "hi!" + "'", str24, "hi!");
        org.junit.Assert.assertTrue("'" + double25 + "' != '" + 10.0d + "'", double25 == 10.0d);
        org.junit.Assert.assertEquals("'" + str26 + "' != '" + "hi!" + "'", str26, "hi!");
    ...
    public void test8968() throws Throwable {
        ...
        double double4 = produto3.getPreco();
        org.junit.Assert.assertTrue("'" + double4 + "' != '" + (-89.0d) + "'", double4 == (-89.0d));
    }
    ...
    public void test8973() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + double8 + "' != '" + 10.0d + "'", double8 == 10.0d);
        org.junit.Assert.assertEquals("'" + str11 + "' != '" + "" + "'", str11, "");
        org.junit.Assert.assertTrue("'" + double14 + "' != '" + 196.0d + "'", double14 == 196.0d);
    }
    ...
    public void test8976() throws Throwable {
        ...
        java.lang.Class<?> wildcardClass62 = produto47.getClass();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int24 + "' != '" + (-1) + "'", int24 == (-1));
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "hi!" + "'", str33, "hi!");
        org.junit.Assert.assertTrue("'" + double34 + "' != '" + 10.0d + "'", double34 == 10.0d);
    ...
    public void test8977() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            estoque0.inserirProduto(produto52, 28);
            org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
            // Expected exception.
        }
    ...
    public void test8986() throws Throwable {
        ...
        java.lang.Class<?> wildcardClass25 = produto15.getClass();
    ...
    public void test8990() throws Throwable {
        ...
        produto42.setNome("");
        double double60 = produto42.getPreco();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int14 + "' != '" + 0 + "'", int14 == 0);
        org.junit.Assert.assertTrue("'" + boolean24 + "' != '" + false + "'", boolean24 == false);
        org.junit.Assert.assertTrue("'" + int26 + "' != '" + 0 + "'", int26 == 0);
    ...
    public void test8996() throws Throwable {
        ...
        produto71.setNome("hi!");
        produto71.setPreco((double) 96);
        produto71.setCodigo("hi!");
        estoque0.inserirProduto(produto71, 96);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int17 + "' != '" + 0 + "'", int17 == 0);
        org.junit.Assert.assertTrue("'" + boolean20 + "' != '" + false + "'", boolean20 == false);
        org.junit.Assert.assertTrue("'" + int42 + "' != '" + (-1) + "'", int42 == (-1));
    ...
    public void test8999() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            estoque0.inserirProduto(produto64, 84);
            org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
            // Expected exception.
        }
